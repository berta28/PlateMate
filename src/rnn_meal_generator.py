...
class RNNMealGenerator:
    ...
    def train_rnn(self,features, targets):
        ...
        model = nn.RNN(input_size=input_size, hidden_size=hidden_size, num_layers=1 ,batch_first=True)
    ...
    def predict(self, user):
        ...
        for recipe in recipe_list:
            print(recipe.title)
        return MealPlan(recipes=recipe_list, grocery_list=GroceryList(ingredients=Ingredient("None")), estimated_cost=1)
